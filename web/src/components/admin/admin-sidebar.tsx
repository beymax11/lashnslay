...
type TabType = "appointments" | "analytics" | "clients" | "schedule";
...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside className={`hidden lg:flex flex-col gap-3 pb-0 border-r border-luxury-light-gray dark:border-neutral-800 lg:py-10 relative transition-all duration-300 ease-in-out shrink-0 select-none ${
        isSidebarCollapsed ? "w-20 px-4" : "w-60 px-6"
      }`}>
